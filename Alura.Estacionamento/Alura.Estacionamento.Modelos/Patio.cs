...
>>>>>>> d4f872ea1df0ac0aaead8519bc782100e913acae
...
<<<<<<< HEAD
        ...
        {
            var found = (from veiculo in this.Veiculos where veiculo.IdTicket == IdTicket select veiculo).SingleOrDefault();
            return found;
        }

        public Veiculo AlterarDadosVeiculo(Veiculo v2)
        {
            var vTemp = (from veiculo in this.Veiculos where veiculo.Placa == v2.Placa select veiculo).SingleOrDefault();
            vTemp.AlterarDados(v2);
            return vTemp;
        }
        ...
        private string GerarTicket(Veiculo veiculo)
        {
            ...
            string ticket = "### Ticket de Estacionamento ###" +
