...
<<<<<<< HEAD
            ...
            set
            {
                if(value.Length < 3)
                {
                    throw new System.FormatException("Nome do proprietário com menos caracteres que o necessário.");
                }
                _proprietario = value;
            }
=======
...
<<<<<<< HEAD
        ...
        public void AlterarDados(Veiculo v2)
        {
            this.Proprietario = v2.Proprietario;
            this.Modelo = v2.Modelo;
            this.Largura = v2.Largura;
            this.Cor = v2.Cor;
        }
